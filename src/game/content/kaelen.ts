...
I do not take scrip. I do not take blessing. I do not ride."`,
    ...
    choices: [
      ...
      },
      {
        ...
        sub: 'One scrap. A heading. The Court is still a walk.',
        show: { all: [{ item: 'scrap' }, { flagUnset: 'kaelenRunnerRumor' }] },
        effects: {
          remove: { scrap: 1 },
      ...
      },
      {
        ...
        sub: 'One scrap. The paddock is still a walk.',
        show: { all: [{ item: 'scrap' }, { flagUnset: 'kaelenOramRumor' }] },
        effects: {
          remove: { scrap: 1 },
